...
def read_data(filename):
    ...
    return tuple(data)
cases = read_data("PFC_backpress_case.txt")
    ...
    for epoch_time in epoch_time_list:
        for detect_times in step_detect_times_list:
            for i, case in enumerate(cases):
                ...
                config_file.write("\n")
                data_path = "mix_allreduce/PFC_backpress_tests/data/data_"+file_str
...
file.write("    file={}\n")
file.write("    python ./waf --run \"scratch/mix_allreduce mix_allreduce/PFC_backpress_tests/config/config_${file}.txt\"\n")
file.write("    python3 mix_allreduce/PFC_backpress_tests/graph.py \"mix_allreduce/PFC_backpress_tests/data/data_${file}\"\n")
file.write("'\n")
file.close()